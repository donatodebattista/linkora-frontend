...
export default function HandleData({ data } : HandleDataProps) {
  ...
  return (
    <div className="text-white text-center space-y-4 flex flex-col items-center bg-linear-to-b from-sky-950 to-black px-10 py-10 rounded-lg shadow-2xl/20 shadow-sky-800">
